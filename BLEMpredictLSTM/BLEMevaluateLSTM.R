...
## Train LSTM neural network, use it for predictions,
## and calculate error measures
...
# Path can be set to "data/prosumer/" or "data/consumers/"
...
for(id in files) {
    ...
    model_best %>% save_model_hdf5("models/"%&%id%&%".hdf5")
    
    
    
    ###  Model evaluation  ###
    
    pred_model = load_model_hdf5("models/"%&%id%&%".hdf5")
